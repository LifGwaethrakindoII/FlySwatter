...
namespace Voidless
{
    ...
    public static class VCameraExtensions
    {
        ...
        /// <summary>
        /// Evaluates if a point is inside the most recent active Scene view's camera's viewport.
        /// </summary>
        /// <param name="p">The point, in world coords, to evaluate.</param>
        /// <returns>True if point is inside viewport's area.</returns>
        public static bool PointInsideSceneViewport(Vector3 p)
        {
#if UNITY_EDITOR
            Vector3 viewportPos = SceneView.lastActiveSceneView.camera.WorldToViewportPoint(p);
