...
namespace Voidless
{
	...
	public static class VCoroutines
	{
        ...
        /// <summary>Creates new Asynchronous FSMCoroutine as a Coroutine.</summary>
        /// <param name="_monoFSMCoroutine">MonoFSMCoroutine that will start the coroutine.</param>
        /// <param name="_iterator">Coroutine's Iterator.</param>
        /// <param name="_startAutomagically">Start the coroutine as soon as the FSMCoroutine is initialized [true by default].</param>
        /// <returns>Created FSMCoroutine.</returns>
        public static FSMCoroutine StartFSMCoroutine(this MonoBehaviour _monoBehaviour, IEnumerator _iterator, bool _startAutomagically = true)
        {
            return new FSMCoroutine(_monoBehaviour, _iterator, _startAutomagically);
        }
