...
namespace Voidless
{
	public static class VBounds
	{
		...
		/// <summary>
	    /// Checks if Bounds 'a' fully contains Bounds 'b'.
	    /// </summary>
	    /// <param name="a">The outer Bounds.</param>
	    /// <param name="b">The inner Bounds to check containment.</param>
	    ...
	    // Check if two bounding boxes (Bounds) intersect
