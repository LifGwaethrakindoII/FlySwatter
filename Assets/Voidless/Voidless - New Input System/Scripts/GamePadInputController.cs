...
{
    /// <summary>Event invoked when a Controller-Input occurs.</summary>
    /// <param name="_input">Controller-Input's Enum value</param>
    /// <param name="_event">Type of Controller-Input Event.</param>
    /// <param name="_context">Callback context associated with the event</param>
    public delegate void OnControllerInputEvent(ControllerInput _input, ControllerInputEvent _event, CallbackContext _context);
    ...
    public enum ControllerInputEvent
    {
        Started,
        Performed,
        Canceled
    ...
    {
        public event OnControllerInputEvent onControllerInputEvent;
...
#region Getters/Setters:
        ...
        /// <summary>Invokes OnControllerInputEvent's delegate.</summary>
        /// <param name="_input">Controller-Input's Enum Value.</param>
        /// <param name="_event">Type of Controller-Input Event.</param>
        /// <param name="_context">Callback's Context.</param>
        private void InvokeControllerInputEvent(ControllerInput _input, ControllerInputEvent _event, CallbackContext _context)
        {
            if(onControllerInputEvent != null) onControllerInputEvent(_input, _event, _context);
        }
...
======================================================================================================================*/
        ...
        protected virtual void OnDPadLeftInputActionStarted(CallbackContext _context)
        {
            ...
            InvokeControllerInputEvent(ControllerInput.DPadLeft, ControllerInputEvent.Started, _context);
        }
        ...
        protected virtual void OnDPadRightInputActionStarted(CallbackContext _context)
        {
            ...
            InvokeControllerInputEvent(ControllerInput.DPadRight, ControllerInputEvent.Started, _context);
        }
        ...
        protected virtual void OnDPadDownInputActionStarted(CallbackContext _context)
        {
            ...
            InvokeControllerInputEvent(ControllerInput.DPadDown, ControllerInputEvent.Started, _context);
        }
        ...
        protected virtual void OnDPadUpInputActionStarted(CallbackContext _context)
        {
            ...
            InvokeControllerInputEvent(ControllerInput.DPadUp, ControllerInputEvent.Started, _context);
        }
        ...
        protected virtual void OnLeftStickClickInputActionStarted(CallbackContext _context)
        {
            ...
            InvokeControllerInputEvent(ControllerInput.LeftStick, ControllerInputEvent.Started, _context);
        }
        ...
        protected virtual void OnRightStickClickInputActionStarted(CallbackContext _context)
        {
            ...
            InvokeControllerInputEvent(ControllerInput.RightStick, ControllerInputEvent.Started, _context);
        }
        ...
        protected virtual void OnLeftActionInputActionStarted(CallbackContext _context)
        {
            ...
            InvokeControllerInputEvent(ControllerInput.LeftAction, ControllerInputEvent.Started, _context);
        }
        ...
        protected virtual void OnRightActionInputActionStarted(CallbackContext _context)
        {
            ...
            InvokeControllerInputEvent(ControllerInput.RightAction, ControllerInputEvent.Started, _context);
        }
        ...
        protected virtual void OnDownActionInputActionStarted(CallbackContext _context)
        {
            ...
            InvokeControllerInputEvent(ControllerInput.DownAction, ControllerInputEvent.Started, _context);
        }
        ...
        protected virtual void OnUpActionInputActionStarted(CallbackContext _context)
        {
            ...
            InvokeControllerInputEvent(ControllerInput.UpAction, ControllerInputEvent.Started, _context);
        }
        ...
        protected virtual void OnLeftShoulder1InputActionStarted(CallbackContext _context)
        {
            ...
            InvokeControllerInputEvent(ControllerInput.LeftShoulder1, ControllerInputEvent.Started, _context);
        }
        ...
        protected virtual void OnLeftShoulder2InputActionStarted(CallbackContext _context)
        {
            ...
            InvokeControllerInputEvent(ControllerInput.LeftShoulder2, ControllerInputEvent.Started, _context);
        }
        ...
        protected virtual void OnRightShoulder1InputActionStarted(CallbackContext _context)
        {
            ...
            InvokeControllerInputEvent(ControllerInput.RightShoulder1, ControllerInputEvent.Started, _context);
        }
        ...
        protected virtual void OnRightShoulder2InputActionStarted(CallbackContext _context)
        {
            ...
            InvokeControllerInputEvent(ControllerInput.RightShoulder2, ControllerInputEvent.Started, _context);
        }
